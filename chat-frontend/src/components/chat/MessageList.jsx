...
import { wallpaperStyleFor } from "../modals/WallpaperPicker"
          ...
          const quizClass = revealCorrect
            ? option.is_correct
              ...
              : isMine
                ...
                : ""
            : ""
          const voterNames = (option.voters || []).map((v) => v.display_name)
      ...
      {!loading && messages.length === 0 ? (
        <div className="message-list-empty-state">
          ...
          <p className="message-list-empty-subtext">
            Say hello to {selectedUser?.full_name || 'Unknown'}
          </p>
        </div>
      ) : (
        <>
                      ...
                      <div className="message-list-content">
                        ...
                        {msg.forwarded_from && (
                          <div className="message-list-forwarded-label">
                            ➡️ Forwarded from {msg.forwarded_from.sender_display_name}
                          </div>
                        )}
                        ...
                        {msg.reply_to && msg.reply_to.content && msg.reply_to.id !== msg.id && (
                          ...
                          >
                            <div className="message-list-reply-sender">
                              {msg.reply_to.sender_display_name || ""}
                            </div>
