    ...
    openCallPrompt(
      {
        ...
        username: call.other_user.full_name || "Unknown",
                ...
                >
                  <div className="contacts-avatar">
                    {call.other_user.avatar_url ? (
                      <img src={call.other_user.avatar_url} alt={call.other_user.full_name || "Unknown"} />
                    ) : (
                      <div
                        className="contacts-avatar-placeholder"
                        style={{ background: getAvatarColor(call.other_user.username) }}
                      >
                        {(call.other_user.full_name || "Unknown")[0].toUpperCase()}
                      </div>
                    )}
                  </div>
                  <div className="contacts-info">
                    <span className="contacts-name">{call.other_user.full_name || "Unknown"}</span>
